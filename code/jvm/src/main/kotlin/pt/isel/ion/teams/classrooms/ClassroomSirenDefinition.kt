...
fun CollectionModel.toClassroomSirenObject(
    classroomList: List<ClassroomCompactOutputModel>,
    orgId: Int
    ...
    return SirenEntity(
        ...
        links = listOfNotNull(
            ...
            if (classroomList.size > pageSize) nextLink(Uris.Classrooms.makePage(pageIndex + 1, pageSize))
            else null,
            if (pageIndex > 0) prevLink(Uris.Classrooms.makePage(pageIndex - 1, pageSize)) else null,
...
fun ClassroomOutputModel.toStudentSirenObject(
    ...
    links = listOf(
        ...
        SirenLink(SirenRelations.AVATAR, URI(this.githubAvatar)),
        SirenLink(SirenRelations.ORGANIZATION, Uris.Organizations.Organization.make(orgId)),
