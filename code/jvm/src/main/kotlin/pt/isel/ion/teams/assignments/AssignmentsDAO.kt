...
interface AssignmentsDAO {
    ...
    @SqlUpdate("UPDATE assignments SET releasedate = COALESCE(:releaseDate,releasedate), name = COALESCE(:name,name), description = COALESCE(:description,description) WHERE id=:id")
    @GetGeneratedKeys
